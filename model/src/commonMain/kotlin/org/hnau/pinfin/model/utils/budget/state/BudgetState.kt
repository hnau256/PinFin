...
data class BudgetState(
    ...
    val info: BudgetInfo,
    val transactions: List<KeyValue<Transaction.Id, Transaction<KeyValue<AccountId, AccountInfo>, KeyValue<CategoryId, CategoryInfo>, Records<KeyValue<CategoryId, CategoryInfo>>>>>,
