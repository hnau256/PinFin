...
import org.hnau.pinfin.model.budget.analytics.tab.periods.configure.period.NonNegativeCountModel

/**
 * Порт `graph.configure.period.NonNegativeCountProjector` для [NonNegativeCountModel]
 * из пакета `periods` (см. docs/analytics-v2-plan.md, "2.6").
 */
